...
public class VerIndividualPWController implements Initializable {
    ...
    private void eliminar(ActionEvent event) {
        ...
        if (resultado.isPresent() && resultado.get() == ButtonType.OK) {
            String sql = "{CALL eliminar_PublicidadAnuncioWeb(?)}";  // Llamada al procedimiento almacenado
            try {
                ...
                showAlert(Alert.AlertType.ERROR, "Error de Base de Datos", "No se pudo eliminar el Publicidad Web: " + e.getMessage());
            }
        }
    }
