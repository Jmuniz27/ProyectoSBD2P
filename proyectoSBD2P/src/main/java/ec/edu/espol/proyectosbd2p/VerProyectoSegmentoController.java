 ...
 * @author zahid
 */
public class VerProyectoSegmentoController implements Initializable {
    ...
    @FXML
    private Label txtDepProduccion;
    @FXML
    private Button btnEditarSegmento;
    @FXML
    private Button btnEliminarSegmento;
    ...
    @FXML
    private void editarSegmento(ActionEvent event) {
    }

    @FXML
    private void eliminarSegmento(ActionEvent event) {
    }
